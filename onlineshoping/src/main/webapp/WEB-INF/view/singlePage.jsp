		...
		<div class="col-xs-12 col-sm-8">
			...
			<c:choose>
				<c:when test="${product.quantity < 1}">
					<h6>
						Qt Ava : <strong style="color: red">Out of Stock</strong>
					</h6>

				</c:when>
				<c:otherwise>
					<h6>
						Qt Ava : <strong>${product.quantity }</strong>
					</h6>
				...
				<c:choose>
					<c:when test="${product.quantity < 1}">
						...
						<a href="javascript:void(0)" class="btn btn-success disabled"><i
							class="fa fa-shopping-cart" aria-hidden="true">&nbsp;<strike>Add
									to Cart</strike></i></a>
			...
			<security:authorize access="hasAuthority('ADMIN')">
				...
				<a href="${contextroot }/manage/${product.id }/products"
					class="btn btn-warning"><i class="fa fa-pencil-square"
